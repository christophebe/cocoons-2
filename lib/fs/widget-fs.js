  ...
  fs.readdir(dir, function(error, files){
    ...
    async.each(files,
          function(file, callback) {
            ...
            // If the widget is not a pug or HTML file => just an error message
 ...
 *
 * @param the pug template matching to the widget
 * @param(error, compiledTemplate)
 */
var compileWidget = function(widgetFile, callback) {

  util.compilePug(widgetFile, function(error, template){
