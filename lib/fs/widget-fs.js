...
function renderWidgetsForRegion(params, regionWidgets) {
  ...
  return regionHTML.sort(compareWidget);
}


/**
 * compareWidget - Compare sort function for 2 widgets
 *
 * @param  {Object} w1 The first widget
 * @param  {Object} w2 The second widget
 * @return {number} The sort order
 */
function compareWidget(w1, w2) {
  if (w1.order < w2.order) { return -1; }
  if (w1.level > w2.order) { return 1; }
  return 0;
}
