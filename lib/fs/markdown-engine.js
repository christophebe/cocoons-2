...
const pWidget = (params, widgetRenderer) =>
  new Promise(resolve => setImmediate(() => resolve(widgetRenderer.renderWidgets(params))));
const pContent = (params, content, markdownRender) =>
  new Promise(resolve => setImmediate(() => resolve(markdownRender.renderToHTML(params, content))));
