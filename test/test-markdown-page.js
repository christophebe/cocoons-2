...
describe("Test read markdown page and its property file", () => {
  it("should read an existing md file and its properties ", () => md.readPage(FILE_MD_1)
    .then((page) => {
  ...
  it("should return the content without properties for a md file without json", () => md.readPage(FILE_MD_2)
    .then((page) => {
      page.should.be.not.null;
  ...
  it("should return an error when reading an unknown md file ", () => md.readPage("xxx.md")
